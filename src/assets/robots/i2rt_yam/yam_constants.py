"""YAM arm constants and MJCF (bundled under ``src/assets``, no vendored mjlab tree)."""
...
##
# MJCF and assets (next to this file: xmls/yam.xml, xmls/assets/*.stl)
##

_PKG_DIR = Path(__file__).resolve().parent
YAM_XML: Path = _PKG_DIR / "xmls" / "yam.xml"
assert YAM_XML.exists(), f"Missing YAM MJCF: {YAM_XML}"
